...
class array{
	public static void main(String[] args){
		...
		System.out.println("The 2d array is "+Arrays.toString(str));
		//let's sort the array
		Arrays.sort(str);
		System.out.println("After sorting the string array will become "+Arrays.toString(str));
		//let's sort the integer array between 2 to 6 index
		Arrays.sort(arr,2,7);
		System.out.println("After sorting the array from 2nd to 6th index the resultant array is "+Arrays.toString(arr));
		//now I want to fill my whole string array with "Welcome"
		Arrays.fill(str,"Welcome");
		System.out.println("After filling the \'' Welcome \'' value the string array will now become is "+Arrays.toString(str));
		//if I want to create a new array whose starting elements are same as that of "arr" array elements
		System.out.println("After copying the arr elements, here's the original array of length 12 "+Arrays.toString(Arrays.copyOf(arr,12)));
	}
}
